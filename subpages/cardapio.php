...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="./assets/css/pagesCliente/cardapio.css">
...
<body class="body">
  ...
  <script>
    ...
    function atualizarCarrinhoVisual() {
      ...
      if (carrinho.length === 0) {
        ...
        btnLimparActive.classList.remove('active');
        barraDivisaoActive.classList.remove('active');
        cartTitleh6Active.classList.remove('active');
        carttotalh6Active.classList.remove('active');
        carttotalh5Active.classList.remove('active');
        btnFinalizarActive.classList.remove('active');
        ScrollbarActive.classList.remove('active');
      }
    }
  ...
  <script type="module" src="./assets/js/pageCliente/cardapioModal.js"></script>
  <script type="module" src="./assets/js/pageCliente/cardapio.js"></script>
  <!-- Bootstrap 5 JS -->
