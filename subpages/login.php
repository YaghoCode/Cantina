...
<body class="body">
    ...
    <div class="form-container sign-up">
      <form action="login.php" method="post">
        ...
        <div class="custom-select">
          <div class="selected">Escolha uma opção <i class="fa-solid fa-caret-down"></i></div>
          <ul class="options">
            <li data-value="1ds">1°DS</li>
            <li data-value="2ds">2°DS</li>
            <li data-value="3ds">3°DS</li>
            <li data-value="1adm">1°ADM</li>
            <li data-value="2adm">2°ADM</li>
            <li data-value="3adm">3°ADM</li>
            <li data-value="1rh">1°RH</li>
            <li data-value="2rh">2°RH</li>
            <li data-value="3rh">3°RH</li>
            <li data-value="1jd">1°JD</li>
            <li data-value="2jd">2°JD</li>
            <li data-value="3jd">3°JD</li>
          </ul>
        </div>

        <select name="turma" id="realSelect" hidden>
    ...
    <div class="form-container sign-in" id="form-login">
      <form action="login.php" method="post">
        <div style="text-align:center;">
          <h1 class="h1-sign">Bem-vindo ao site da <br> #Cantina-PJ</h1>
        </div>
        <span>Faça o login
  ...
  <script>
    ...
    const realSelect = document.querySelector("#realSelect");
