                                    ...
                                    <div class="form-group-editar-clientes">
                                        ...
                                        <select name="turma" id="turma_editar_cliente" class="form-control" required>
                                           <option value="1DS" <?= $user_data['turma'] == "1DS" ? 'selected' : '' ?>> 1DS
                                                    ...
                                                    <option value="3DS" <?= $user_data['turma'] == "3DS" ? 'selected' : '' ?>>3DS
                                                    </option>
                                                    <option value="1ADM" <?= $user_data['turma'] == "1ADM" ? 'selected' : '' ?>> 1ADM
                                                    </option>
                                                    <option value="2ADM" <?= $user_data['turma'] == "2ADM" ? 'selected' : '' ?>> 2ADM
                                                    </option>
                                                    <option value="3ADM" <?= $user_data['turma'] == "3ADM" ? 'selected' : '' ?>>3ADM
                                                    </option>
                                                    <option value="1RH" <?= $user_data['turma'] == "1RH" ? 'selected' : '' ?>> 1RH
                                                    </option>
                                                    <option value="2RH" <?= $user_data['turma'] == "2RH" ? 'selected' : '' ?>> 2RH
                                                    </option>
                                                    <option value="3RH" <?= $user_data['turma'] == "3RH" ? 'selected' : '' ?>>3RH
                                                    </option>
                                                    <option value="1JD" <?= $user_data['turma'] == "1JD" ? 'selected' : '' ?>> 1JD
                                                    </option>
                                                    <option value="2JD" <?= $user_data['turma'] == "2JD" ? 'selected' : '' ?>> 2JD
                                                    </option>
                                                    <option value="3JD" <?= $user_data['turma'] == "3JD" ? 'selected' : '' ?>>3JD
                                                    </option>
                                        </select>
                                    </div>
                                </div>
